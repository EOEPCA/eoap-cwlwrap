...
- id: main
  ...
  - id: another_input
    ...
    type: string
  - id: aoi
    label: area of interest - pattern-5/aoi
    doc: area of interest as a bounding box - This parameter is derived from 
      pattern-5/aoi
    type: string
  - id: epsg
    label: EPSG code - pattern-5/epsg
    doc: EPSG code - This parameter is derived from pattern-5/epsg
    default: EPSG:4326
    type: string
  - id: indexes
    label: indexes - pattern-5/indexes
    doc: indexes to compute - This parameter is derived from pattern-5/indexes
    default:
    - ndvi
    - ndwi
    type:
      name: _:868aad92-a800-4a2b-91a4-85412028d6ed
      items: string
      type: array
  - id: item
    label: STAC item reference - pattern-5/item
  ...
  - id: vegetation_indexes
    ...
    type:
      name: _:a378e4be-3f20-4de8-9c38-c294f1e9ef4a
...
- id: pattern-5
  ...
  - id: vegetation_indexes
    ...
    type:
      name: _:29a69b76-1e17-4aa2-b8e3-494ccbb38cf6
      items: Directory
      type: array
  requirements:
  - class: ScatterFeatureRequirement
