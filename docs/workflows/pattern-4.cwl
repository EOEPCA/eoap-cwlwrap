...
- id: main
  ...
  - id: another_input
    ...
    type: string
  - id: aoi
    label: area of interest - pattern-4/aoi
    doc: area of interest as a bounding box - This parameter is derived from 
      pattern-4/aoi
    type: string
  - id: epsg
    label: EPSG code - pattern-4/epsg
    doc: EPSG code - This parameter is derived from pattern-4/epsg
    default: EPSG:4326
    type: string
  - id: item
    label: STAC item reference - pattern-4/item
