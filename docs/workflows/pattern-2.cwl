...
- id: main
  ...
  - id: another_input
    ...
    type: string
  - id: aoi
    label: area of interest - pattern-2/aoi
    doc: area of interest as a bounding box - This parameter is derived from 
      pattern-2/aoi
    type: string
  - id: epsg
    label: EPSG code - pattern-2/epsg
    doc: EPSG code - This parameter is derived from pattern-2/epsg
    default: EPSG:4326
    type: string
  - id: bands
    label: bands used for the NDWI - pattern-2/bands
    ...
    - nir08
    type:
      name: _:75933748-fa0d-4c43-9ec9-babf3960e77f
      items: string
      type: array
  - id: item_1
    label: STAC item reference - pattern-2/item_1
  ...
  - id: item_2
    label: STAC item reference - pattern-2/item_2
    doc: Reference to a STAC item - This parameter is derived from 
      pattern-2/item_2
    type: 
      https://raw.githubusercontent.com/eoap/schemas/main/string_format.yaml#URI
...
- id: clt
  ...
  - id: band
    type:
    - name: _:05c19ac3-59c1-4c4c-a12d-43080da0afaf
      items: string
      type: array
      inputBinding:
        prefix: --band
